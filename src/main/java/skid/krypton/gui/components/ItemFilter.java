...
class ItemFilter extends Screen {
    ...
    public void render(final DrawContext drawContext, final int n, final int n2, final float n3) {
        ...
        RenderUtils.a(drawContext, new Color(60, 60, 65, 255), n8, n9, n8 + 540, n9 + 30, 5.0, 5.0, 5.0, 5.0, 1.0, 20.0);
        ...
        TextRenderer.a("Search: " + searchQuery + s, drawContext, n8 + 10, n9 + 9, new Color(200, 200, 200, 255).getRGB());
        final int n10 = n6 + 20;
        final int n11 = n9 + 30 + 15;
        final int n12 = 450 - (n11 - n7) - 60;
        RenderUtils.a(drawContext.getMatrices(), new Color(25, 25, 30, 255), n10, n11, n10 + 540, n11 + n12, 5.0, 5.0, 5.0, 5.0, 20.0);
        ...
        if ((int) ceil > 6) {
            ...
            RenderUtils.a(drawContext.getMatrices(), new Color(20, 20, 25, 150), n13, n14, n13 + 6, n14 + n15, 3.0, 3.0, 3.0, 3.0, 20.0);
            ...
            RenderUtils.a(drawContext.getMatrices(), KryptonUtil.getMainColor(255, 1), n13, n17, n13 + 6, n17 + max2, 3.0, 3.0, 3.0, 3.0, 20.0);
        }
        int i;
        for (int n18 = i = this.scrollOffset * 11; i < Math.min(n18 + Math.min(this.filteredItems.size(), 66), this.filteredItems.size()); ++i) {
            ...
            if (i == this.selectedIndex) {
                mainColor = KryptonUtil.getMainColor(100, 1);
            } else {
        ...
        if (this.filteredItems.isEmpty()) {
            TextRenderer.b("No items found", drawContext, n10 + 270, n11 + n12 / 2 - 10, new Color(150, 150, 150, 200).getRGB());
        }
        final int n21 = n7 + 450 - 45;
        final int n22 = n6 + 580 - 80 - 20;
        final int n23 = n22 - 80 - 10;
        final int n24 = n23 - 80 - 10;
        RenderUtils.a(drawContext.getMatrices(), KryptonUtil.getMainColor(255, 1), n22, n21, n22 + 80, n21 + 30, 5.0, 5.0, 5.0, 5.0, 20.0);
        TextRenderer.b("Save", drawContext, n22 + 40, n21 + 8, new Color(245, 245, 245, 255).getRGB());
        RenderUtils.a(drawContext.getMatrices(), new Color(60, 60, 65, 255), n23, n21, n23 + 80, n21 + 30, 5.0, 5.0, 5.0, 5.0, 20.0);
        TextRenderer.b("Cancel", drawContext, n23 + 40, n21 + 8, new Color(245, 245, 245, 255).getRGB());
        RenderUtils.a(drawContext.getMatrices(), new Color(70, 40, 40, 255), n24, n21, n24 + 80, n21 + 30, 5.0, 5.0, 5.0, 5.0, 20.0);
        TextRenderer.b("Reset", drawContext, n24 + 40, n21 + 8, new Color(245, 245, 245, 255).getRGB());
        RenderUtils.d();
    }
